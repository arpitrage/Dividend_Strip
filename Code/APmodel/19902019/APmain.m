...
% % L1(I_divgrm==1,10)          = LL1(15);
% % L1(I_divgrm==1,17)          = LL1(16);
% 
% % reits & infra
% x_init(35:55) = LL2(3:23);
...
% % L1(I_divgr_reit==1,10)           =LL2(11);
% % L1(I_divgr_reit==1,17)           =LL2(12);
...
% % L1(I_divgr_infra==1,17)          =LL2(23);
% 
% % small and growth 
% x_init(56:83) = LL3(3:30);
...
% % L1(I_divgr_small==1,17)           = LL3(15);
% % L1(I_divgr_growth==1,I_pi==1)     = LL3(16);
% % L1(I_divgr_growth==1,I_gdp==1)    = LL3(17);
% % L1(I_divgr_growth==1,I_y1==1)     = LL3(18);
% % L1(I_divgr_growth==1,I_yspr==1)   = LL3(19);
% % L1(I_divgr_growth==1,I_pdm==1)    = LL3(20);
% % L1(I_divgr_growth==1,I_divgrm==1) = LL3(21);
% % L1(I_divgr_growth==1,I_pd_reit==1)= LL3(22);
% % L1(I_divgr_growth==1,8)           = LL3(23);
% % L1(I_divgr_growth==1,9)           = LL3(24);
% % L1(I_divgr_growth==1,10)          = LL3(25);
% % L1(I_divgr_growth==1,11)          = LL3(26);
% % L1(I_divgr_growth==1,12)          = LL3(27);
% % L1(I_divgr_growth==1,13)          = LL3(28);
% % L1(I_divgr_growth==1,14)          = LL3(29);
% % L1(I_divgr_growth==1,17)          = LL3(30);
% 
% % NR and value
% x_init(84:118) = LL4(3:37);
...
% % L1(I_divgr_NR==1,17)               = LL4(19);
% % L1(I_divgr_value==1,I_pi==1)          = LL4(20);
% % L1(I_divgr_value==1,I_gdp==1)         = LL4(21);
% % L1(I_divgr_value==1,I_y1==1)          = LL4(22);
% % L1(I_divgr_value==1,I_yspr==1)        = LL4(23);
% % L1(I_divgr_value==1,I_pdm==1)         = LL4(24);
% % L1(I_divgr_value==1,I_divgrm==1)      = LL4(25);
% % L1(I_divgr_value==1,I_pd_reit==1)     = LL4(26);
% % L1(I_divgr_value==1,8)                = LL4(27);
% % L1(I_divgr_value==1,9)                = LL4(28);
% % L1(I_divgr_value==1,10)               = LL4(29);
% % L1(I_divgr_value==1,11)               = LL4(30);
% % L1(I_divgr_value==1,12)               = LL4(31);
% % L1(I_divgr_value==1,13)               = LL4(32);
% % L1(I_divgr_value==1,14)               = LL4(33);
% % L1(I_divgr_value==1,15)               = LL4(34);
% % L1(I_divgr_value==1,16)               = LL4(35);
% % L1(I_divgr_value==1,17)               = LL4(36);
% % L1(I_divgr_value==1,18)               = LL4(37);
% x_init = x_init';
...
L1(I_divgrm==1,10)               = x(i);i=i+1;
L1(I_divgrm==1,17)               = x(i);i=i+1;
...
L1(I_divgr_reit==1,10)           = x(i);i=i+1;
L1(I_divgr_reit==1,17)           = x(i);i=i+1;
...
L1(I_divgr_infra==1,17)          = x(i);i=i+1;

% small & growth stocks (56-83)
...
L1(I_divgr_small==1,17)               = x(i);  i = i+1;
...
L1(I_divgr_growth==1,8)                = x(i);  i = i+1;
L1(I_divgr_growth==1,9)                = x(i);  i = i+1;
L1(I_divgr_growth==1,10)               = x(i);  i = i+1;
...
L1(I_divgr_growth==1,17)               = x(i);  i = i+1;
...
L1(I_divgr_NR==1,8)                = x(i);  i = i+1;
L1(I_divgr_NR==1,9)                = x(i);  i = i+1;
L1(I_divgr_NR==1,10)               = x(i);  i = i+1;
...
L1(I_divgr_value==1,8)                = x(i);  i = i+1;
L1(I_divgr_value==1,9)                = x(i);  i = i+1;
L1(I_divgr_value==1,10)               = x(i);  i = i+1;
...
portfdivfuturereturn_model = 400*mean(mean(divfuturereturn(2:29,117-64:158-64),2)); % avg of first 28 quarterly strip returns, avg from 2003.Q1-2014.Q2 
...
divfutureriskprem_model_short = mean(400*(Am(1:end-1)-Api(1:end-1)-Am(2:end)+Api(2:end) +mu_m+pi0...
    +((Bm(:,1:end-1)-Bpi(:,1:end-1)+I_divgrm+I_pi)'*Psi -(Bm(:,2:end)-Bpi(:,2:end))')*X2(117-64:158-64,:)'),2);
...
if printfigs==1
    savefig('Yields_short')
    print('Yields_short','-depsc')
    movefile('Yields_short.eps', '..\..\..\Figures');
end
...
set(findall(gcf,'-property','FontSize'),'FontSize',14)
if printfigs==1
    savefig('Yieldsreal_short')
    print('Yieldsreal_short','-depsc')
    movefile('Yieldsreal_short.eps', '..\..\..\Figures');
end
...
xlim([1989,2020]);ylim([0,110]);
legend('model','data','Location','NorthWest')
title('Price-Dividend Ratio on Value') 
set(findall(gcf,'-property','FontSize'),'FontSize',14)
if printfigs==1
    savefig('ERPpart1_short')
    print('ERPpart1_short','-depsc')
    movefile('ERPpart1_short.eps', '..\..\..\Figures');
end
...
xlim([1989,2020]);ylim([0,35]);
legend('model','data','Location','NorthEast')
title('Price-Dividend Ratio on NR') 
if printfigs==1
    savefig('ERPpart2_short')
    print('ERPpart2_short','-depsc')
    movefile('ERPpart2_short.eps', '..\..\..\Figures');
end
...
set(findall(gcf,'-property','FontSize'),'FontSize',14)
if printfigs==1
    savefig('StripsPDshare_short')
    print('StripsPDshare_short','-depsc')
    movefile('StripsPDshare_short.eps', '..\..\..\Figures');
end
...
set(findall(gcf,'-property','FontSize'),'FontSize',14)
if printfigs==1
    savefig('Stripprices_short')
    print('Stripprices_short','-depsc')
    movefile('Stripprices_short.eps', '..\..\..\Figures');
end
...
if printfigs==1
    savefig('Stripriskpremia_short')
    print('Stripriskpremia_short','-depsc')
    movefile('Stripriskpremia_short.eps', '..\..\..\Figures');
end
...
if printfigs==1
    savefig('Expretstrips_short')
    print('Expretstrips_short','-depsc')
    movefile('Expretstrips_short.eps', '..\..\..\Figures');
end
...
if printfigs==1
    savefig('Mm_short')
    print('Mm_short','-depsc')
    movefile('Mm_short.eps', '..\..\..\Figures');
end


% save some AP model outputs to be read directly into the latex paper file
if printfigs==1
    matrix2latex(Psi,'Psimat_short.tex', 'alignment', 'c', 'format', '%-3.2f','size','footnotesize');
    movefile('Psimat_short.tex', '..\..\..\Figures');
    matrix2latex(100*Sig,'Sigmat_short.tex', 'alignment', 'c', 'format', '%-3.2f','size','footnotesize');
    movefile('Sigmat_short.tex', '..\..\..\Figures');
    matrix2latex(L0','L0mat_short.tex', 'alignment', 'c', 'format', '%-3.2f','size','footnotesize');
    movefile('L0mat_short.tex', '..\..\..\Figures');
    matrix2latex(L1,'L1mat_short.tex', 'alignment', 'c', 'format', '%-3.1f','size','footnotesize');
    movefile('L1mat_short.tex', '..\..\..\Figures');

    fID = fopen('../../../Figures/TableLambda_short.tex','w'); % create the tex file, and write on it 
...
%% Save output to be used in PE analysis
disp('Saving results to be used in PE analysis')
if printfigs==1
    save APoutputPEinput_19902019 zcbprices divstripprices_stock divstripprices_reit divstripprices_infra divstripprices_small divstripprices_growth divstripprices_NR divstripprices_value...
...
set(findall(gcf,'-property','FontSize'),'FontSize',12)
if printfigs==1
    savefig('shockexposureelast_short')
    print('shockexposureelast_short','-depsc')
    movefile('shockexposureelast_short.eps', '..\..\..\Figures');
end
...
set(findall(gcf,'-property','FontSize'),'FontSize',12)
if printfigs==1
    savefig('shockpriceelast_short')
    print('shockpriceelast_short','-depsc')
    movefile('shockpriceelast_short.eps', '..\..\..\Figures');
end
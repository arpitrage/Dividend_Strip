...
skipestimation=0; %flag if you want to skip the estimation
...
if skipestimation==1
    disp('skipping estimation')
else
    global counts
    counts = 0;
    options = optimset('DiffMinChange',.01,'TolX',0.1,'TolFun',0.001,'MaxIter',1000,'MaxFunEval',1000);

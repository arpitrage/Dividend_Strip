...
load(file = "/Users/agupta011/Dropbox/Research/Infrastructure/JFfinal/Synthetic Data/YearlyCashFlowOct20.Rda")
...
#fund.quarterly.div = left_join(fund.quarterly, states)
...
fund.quarterly.div = fund.quarterly.div %>% mutate(Age.Quarter = Transaction.Quarter.Age/4,
...
fund.quarterly.div = fund.quarterly.div %>%
  mutate(Fund.ID = new.ids)

save(fund.quarterly.div, file = "/Users/agupta011/Dropbox/Research/Infrastructure/JFfinal/Synthetic Data/MergedCashFlowOct20.Rda")
